    ...
    <section className="pt-32 pb-10 px-4 md:px-12 lg:px-24 relative z-5">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4 my-12 max-w-4xl mx-auto">
          <Button 
            variant="default" 
            className="bg-gradient-to-br from-brand-purple via-brand-purple-dark to-deep-purple text-white font-semibold border border-purple-400/60 hover:opacity-90 hover:scale-[1.03] transform transition-all duration-200 shadow-md hover:shadow-lg hover:shadow-purple-500/40 py-3 px-6 rounded-lg"
