...
/**
 * EmbedManager - A utility class for managing embeds like Tally forms and YouTube videos
 * Handles initialization, loading, and refreshing of embeds across the application
 */
...
class EmbedManager {
  ...
  /**
   * Sets up a mutation observer to detect DOM changes and reinitialize embeds
   */
  setupObserver() {
    try {
